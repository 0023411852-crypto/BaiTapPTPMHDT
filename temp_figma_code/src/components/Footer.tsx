const footerLinks = {
  Products: ['VPS Cloud', 'Dedicated Servers', 'Object Storage', 'Kubernetes Engine', 'Global CDN', 'DDoS Protection'],
  Company: ['About Us', 'Careers', 'Press Kit', 'Blog', 'Investors', 'Contact'],
  Developers: ['Documentation', 'API Reference', 'Status Page', 'Changelog', 'CLI Tools', 'Terraform Provider'],
  Legal: ['Privacy Policy', 'Terms of Service', 'Cookie Policy', 'GDPR Compliance', 'SLA', 'Abuse Reports'],
}
...
export default function Footer() {
  return (
    <footer className="relative border-t" style={{ borderColor: 'rgba(99,179,255,0.08)' }}>
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-6 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-sm text-slate-500 leading-relaxed mb-6 max-w-xs">
              Enterprise cloud infrastructure for teams that demand performance, reliability, and control.
            </p>
            {/* Status badge */}
        ...
        >
          <p className="text-xs text-slate-600 font-mono">
            © 2026 NovaCloud Technologies, Inc. All rights reserved.
          </p>
