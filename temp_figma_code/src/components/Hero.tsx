...
const stats = [
  ...
  { value: '180+', label: 'Global PoPs' },
  { value: '2.4M', label: 'Servers Managed' },
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        >
          ...
          Enterprise Cloud Infrastructure · AI-Powered Autoscaling
        </div>
        ...
        >
          NovaCloud gives you bare-metal performance, global edge delivery, and one-click
          Kubernetes — all managed from a single control plane.
        </p>
